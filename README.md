...
You are able to track a specific version or the latest within that major version number. For instance, you can use `v1.3.0` like so,
```yaml
      - name: Setup dockem-rs
        uses: LynchSKM/setup-dockem-rs@v1.3.0

...
You are able to track a specific version or the latest within that major version number. For instance, you can use `v1.0.5` like so,
```yaml
      - name: Setup Dockem
        uses: LynchSKM/setup-dockem-rs@v1.0.5
